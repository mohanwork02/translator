...
api_key = st.text_input("Enter OpenAI API Key", type="password")  # Secure input for API key

# Ensure that the API key is provided
if api_key:
    openai.api_key = api_key  # Use the user-provided API key
    ...
    st.warning("Please enter your OpenAI API key to use the translation.")
